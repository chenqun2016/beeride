...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkLineText = typedArray == null?"":typedArray.getString(R.styleable.SwitchButton_sb_checkline_text);
    ...
    protected void drawCheckedIndicator(Canvas canvas,
        ...
        if(!TextUtils.isEmpty(checkLineText)){
            paint.setStyle(Paint.Style.FILL);
            ...
            float baseline=(sy+ey)/2f+distance;
            canvas.drawText(checkLineText,sx,baseline,paint);
            return;
        }
        paint.setStyle(Paint.Style.STROKE);
